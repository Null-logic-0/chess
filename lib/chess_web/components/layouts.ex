  ...
  def app(assigns) do
    ...
    <header class="navbar flex justify-between items-center px-4 sm:px-6 lg:px-8">
      <a href="/" class="flex items-center gap-2">
        <span class="bg-primary rounded-lg p-2 w-10 h-10 flex items-center justify-center">
          <img src="/images/logo.png" alt="logo" />
        </span>
        <h1 class="text-3xl text-primary font-semibold">ChessHub</h1>
      </a>
